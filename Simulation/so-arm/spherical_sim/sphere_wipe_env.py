      ...
      <mujoco model="sphere_wipe">
        ...
        <worldbody>
          ...
          <body name="ball" pos="0 0 {sphere_radius}">
            <geom name="ball_geom" type="sphere" size="{sphere_radius}" rgba="0.8 0.8 1 1" contype="1" conaffinity="1"/>
          </body>
          ...
          <body name="base" pos="0 0 {arm_base_height}">
            ...
            <body name="link1" pos="0 0 0.02">
              ...
              <geom type="capsule" fromto="0 0 0 0 0 {l1}" size="0.02" rgba="0.6 0.6 0.6 1"/>

              <!-- link2 -->
              <body name="link2" pos="0 0 {l1}">
                <joint name="j2" type="hinge" axis="0 1 0" range="-110 110" />
                <geom type="capsule" fromto="0 0 0 0 0 {l2}" size="0.018" rgba="0.6 0.6 0.6 1"/>

                <!-- link3 + パッド -->
                <body name="link3" pos="0 0 {l2}">
                  <geom type="capsule" fromto="0 0 0 0 0 {l3}" size="0.015" rgba="0.6 0.6 0.6 1"/>
...
class SphereWipeEnv(gym.Env):
    ...
    観測: 3関節角(qpos) + 3関節角速度(qvel) + 進捗指標(coverage, 最近のユニーク拭き量)
    ...
    def __init__(
        ...
        # 観測・行動空間
        obs_high = np.ones(3 + 3 + 2, dtype=np.float32) * np.inf
